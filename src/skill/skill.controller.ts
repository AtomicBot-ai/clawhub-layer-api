...
export class SkillController {
  ...
  @Get()
  @ApiOperation({ summary: 'List skills', description: 'Paginated list of skills with sorting and filtering' })
  ...
  @Get('search')
  @ApiOperation({ summary: 'Search skills', description: 'Full-text search across slug, displayName and summary. Falls back to ClawHub search API if no local results.' })
